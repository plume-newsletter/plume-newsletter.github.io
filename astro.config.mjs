  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        { label: 'Guides', items: ['docs/connecting-ses', 'docs/email-providers', 'docs/brands-lists-campaigns', 'docs/subscribers', 'docs/sending', 'docs/tracking-suppression', 'docs/additional-features', 'docs/rss', 'docs/n8n'] },
